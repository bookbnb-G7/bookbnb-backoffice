      ...
      <CCard>
        ...
        <CCardBody>
          ...
          <p className="muted">
            ...
            havent heard of them. Photo booth beard raw denim letterpress vegan messenger bag stumptown. Farm-to-table seitan, mcsweeneys fixie
              ...
              {placements.map((placement) => {
                return (
                  <CCol md="4" className="py-4 text-center" key={placement}>
                    <CTooltip content={`Tooltip with placement: ${placement}`} placement={placement}>
